...
<body>
    <div class="container mb-3">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
            <div class="container">
                <a class="navbar-brand" href="{{ route('recruitment.index') }}"><i class="fa fa-arrow-circle-left"
        ...
        <div class="container px-5 mb-5" style="position: relative; margin-top: 100px;">
            ...
            <div class="card">
                <div class="card-body">
                    <form class="row g-3" id="mainForm" action="{{ route('recruitment.update', $data->id) }}"
                        method="post">
                        @csrf
                        @method('PATCH')
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                value="{{ old('name', $data->nama) }}" required>
                            @error('name')
                                <div class="m-1">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="status" id="status" class="form-select">
                                <option value="" {{ $data->status ? '' : 'selected' }} disabled>Select Status
                                </option>
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="date" class="form-control" id="dateofbirth" name="dateofbirth"
                                value="{{ old('dateofbirth', $data->tgl_lahir) }}" required>
                            @error('dateofbirth')
                                <div class="m-1">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" class="form-control" id="placeofbirth" required name="placeofbirth"
                                value="{{ old('placeofbirth', $data->tmp_lahir) }}">
                            @error('placeofbirth')
                                <div class="m-1">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-check-input" type="radio" name="sex" id="sex1" value="1"
                                {{ $data->jenis__kelamin == 1 ? 'checked' : '' }} required>
                            <label for="sex1" class="form-label">Male</label>
                            <input class="form-check-input" type="radio" name="sex" id="sex0"
                                value="0" {{ $data->jenis__kelamin == 0 ? 'checked' : '' }} required>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="marital" name="marital"
                                value="{{ old('marital', $data->status_menikah) }}" required>
                            @error('marital')
                                <div class="m-1">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="nationality" required name="nationality"
                                value="{{ old('nastionality', $data->kewarganegaraan) }}">
                            @error('nastionality')
                                <div class="m-1">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-select" id="religion" name="religion"
                                aria-label="Default select example" required onchange='CheckReligion(this.value);'>

                                <option {{ $data->agama == 'Other' ? 'selected' : '' }} value="Other">Other</option>
                                <option {{ $data->agama == 'Islam' ? 'selected' : '' }} value="Islam">Islam</option>
                                <option {{ $data->agama == 'Protestantism' ? 'selected' : '' }} value="Protestantism">
                                    Protestantism</option>
                                <option {{ $data->agama == 'Catholicism' ? 'selected' : '' }} value="Catholicism">
                                    Catholicism</option>
                                <option {{ $data->agama == 'Hinduism' ? 'selected' : '' }} value="Hinduism">Hinduism
                                </option>
                                <option {{ $data->agama == 'Buddhism' ? 'selected' : '' }} value="Buddhism">Buddhism
                                </option>
                                <option {{ $data->agama == 'Confucianism' ? 'selected' : '' }} value="Confucianism">
                                    Confucianism</option>

                            </select>
                            <input type="text" id="religion_other" class="d-none form-control mt-2"
                                value="{{ old('religion', $data->agama) }}">
                            @error('religion')
                                <div class="m-1">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="health" name="health"
                                value="{{ old('health', $data->kondisi_kesehatan) }}">
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12 mb-5">
                            ...
                            @forelse ($data->pendidikans->where('jenis_pendidikan', 'formal') as $education)
                                <input type="text" hidden name="education[{{ $loop->iteration }}][id]"
                                    value="{{ $education->id }}">
                                <input type="text" hidden name="education[{{ $loop->iteration }}][jenis]"
                                    value="formal">
                                <div class="row text-center rounded py-1 bg-secondary bg-opacity-10">
                                    ...
                                    <div class="col-lg-3 mb-1">
                                        ...
                                        <input type="text" class="form-control" id="school_name"
                                            name="education[{{ $loop->iteration }}][school_name]"
                                            value="{{ $education->nama_instansi }}">
                                    ...
                                    <div class="col-lg-1 mb-1">
                                        ...
                                        <input type="number" class="form-control" id="from"
                                            name="education[{{ $loop->iteration }}][from] "
                                            value="{{ $education->dari }}">
                                    </div>
                                    <div class="col-lg-1 mb-1">

                                        <input type="number" class="form-control" id="to"
                                            name="education[{{ $loop->iteration }}][to]"
                                            value="{{ $education->hingga }}">
                                    </div>
                                    <div class="col-lg-3 mb-1">

                                        <input type="text" class="form-control" id="subject"
                                            name="education[{{ $loop->iteration }}][subject]"
                                            value="{{ $education->jurusan }}">
                                    </div>
                                    <div class="col-lg-3 mb-1">

                                        <textarea name="education[{{ $loop->iteration }}][remark]" class="form-control" style="height: 40px ;"
                                            id="remark-education">{{ $education->keterangan }}</textarea>
                                    </div>
                            ...
                            @empty
                                <div class="row text-center rounded py-1 bg-secondary bg-opacity-10" hidden>
                                    <input type="text" hidden name="education[1][jenis]" value="formal">
                                    <div class="col-lg-3 mb-1">
                                        <input type="text" class="form-control" id="school_name"
                        ...
                        <div class="col-md-12">
                            ...
                            @forelse ($data->pendidikans->where('jenis_pendidikan', 'course') as $course)
                                <input type="text" hidden name="course[{{ $loop->iteration }}][id]"
                                    value="{{ $course->id }}">
                                <input type="text" hidden name="course[{{ $loop->iteration }}][jenis]"
                                    value="course">
                                <div class="row text-center rounded py-1 bg-secondary bg-opacity-10">
                                    <div class="col-lg-3 mb-1">

                                        <input type="text" class="form-control" id="course_name"
                                            name="course[{{ $loop->iteration }}][course_name]"
                                            value="{{ $course->nama_instansi }}">
                                    </div>
                                    <div class="col-lg-1 mb-1">

                                        <input type="number" class="form-control" id="course_from"
                                            name="course[{{ $loop->iteration }}][from]" value="{{ $course->dari }}">
                                    </div>
                                    <div class="col-lg-1 mb-1">

                                        <input type="number" class="form-control" id="course_to"
                                            name="course[{{ $loop->iteration }}][to]" value="{{ $course->hingga }}">
                                    </div>
                                    <div class="col-lg-3 mb-1">

                                        <input type="text" class="form-control" id="course_subject"
                                            name="course[{{ $loop->iteration }}][subject]"
                                            value="{{ $course->jurusan }}">
                                    </div>
                                    <div class="col-lg-3 mb-1">

                                        <textarea name="course[{{ $loop->iteration }}][remark]" class="form-control" style="height: 40px ;"
                                            id="course_remark">{{ $course->keterangan }}</textarea>
                                    </div>
                                    <div class="col-lg-1 mb-1">
                        ...
                        <div class="col-md-12">
                            ...
                            @forelse ($data->bahasas as $bahasa)
                                <div class="row text-center rounded py-1 bg-secondary bg-opacity-10">
                                    <input type="text" hidden name="language[{{ $loop->iteration }}][id]"
                                        value="{{ $bahasa->id }}">
                                    <div class="col-lg-3 mb-1">

                                        <input type="text" class="form-control" id="language"
                                            name="language[{{ $loop->iteration }}][language]"
                                            value="{{ $bahasa->bahasa }}">
                                    </div>
                                    <div class="col-lg-2 mb-1">

                                        <input type="text" class="form-control" list="listOral" id="oral"
                                            name="language[{{ $loop->iteration }}][oral]"
                                            value="{{ $bahasa->lisan }}">
                                    ...
                                    <div class="col-lg-2 mb-1">
                                        ...
                                        <input type="text" class="form-control" list="listWritten" id="written"
                                            name="language[{{ $loop->iteration }}][written]"
                                            value="{{ $bahasa->tulis }}">
                                    ...
                                    <div class="col-lg-4 mb-1">
                                        ...
                                        <textarea name="language[{{ $loop->iteration }}][remark]" class="form-control" style="height: 40px ;"
                                            id="language_remark">{{ $bahasa->keterangan }}</textarea>
                                    </div>
                                    <div class="col-lg-1 mb-1">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control form-floating" id="salary" name="salary"
                                value="{{ old('salary', $data->request_gaji) }}">
                            <input class="form-check-input" type="radio" name="negotiable" id="negotiable"
                                value="1" {{ $data->status_nego_gaji = 1 ? 'checked' : '' }}>
                            ...
                            <input class="form-check-input ms-2" type="radio" name="negotiable" id="notnegotiable"
                                value="0" {{ $data->status_nego_gaji = 0 ? 'checked' : '' }}>
                            <label for="notnegotiable" class="form-label">Not Negotiable</label>
                        </div>
                        <div class="col-md-12">
                            <div class="form-floating">
                                <textarea class="form-control" style="height: 100px"
                                    placeholder="Give a brief description about your strength and weakness" id="floatingTextarea" name="career">{{ old('career', $data->jenjang_karir) }}</textarea>
                        ...
                        <div class="col-md-12">
                            ...
                            @forelse ($data->keluargas as $keluarga)
                                <div class="row text-center rounded py-1 bg-secondary bg-opacity-10">
                                    <input type="text" hidden name="family[{{ $loop->iteration }}][id]"
                                        value="{{ $keluarga->id }}">
                                    <div class="col-lg-2 mb-1">

                                        <input name="family[{{ $loop->iteration }}][relation]" class="form-control"
                                            list="relationlist" id="relation" value="{{ $keluarga->hubungan }}">
                                    ...
                                    <div class=" col-lg-3 mb-1">
                                        ...
                                        <input type="text" class="form-control" id="birth"
                                            ...
                                            value="{{ $keluarga->lahir }}">
                                    </div>
                                    <div class=" col-lg-3 mb-1">

                                        <input type="text" class="form-control" id="occupation"
                                            name="family[{{ $loop->iteration }}][occupation]"
                                ...
                                <div class="col-lg-4">
                                    <div class="form-floating">
                                        <input type="text" name="emergency_relation" list="relationlist"
                                            class="form-control" id="emergency_relation" placeholder="Relationship"
                                            value="{{ old('emergency_relation', $data->relasi_kontak_darurat) }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-floating">
                                        <textarea class="form-control" style="height: 100px"
                                            placeholder="Give a brief description about your strength and weakness" id="floatingTextarea" name="strength">{{ old('strength', $data->strength) }}</textarea>
                                ...
                                <div class="col">
                                    <div class="form-floating">
                                        <textarea class="form-control" style="height: 100px"
                                            placeholder="Give a brief description about your strength and weakness" id="floatingTextarea" name="weakness">{{ old('strength', $data->weakness) }}</textarea>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="activity" name="activity"
                                value="{{ old('activity', $data->aktivitas) }}">
                        </div>
                        <div class="col-md-12">
                            <label for="hobby" class="form-label">Hobby</label>
                            <input type="text" class="form-control" id="hobby" name="hobby"
                                value="{{ old('hobby', $data->hobi) }}">
                        </div>
                        <div class="col-md-12">
                            ...
                            @forelse ($data->organisasis as $organisasi)
                                <input type="text" hidden name="organization[{{ $loop->iteration }}][id]"
                                    value="{{ $organisasi->id }}">
                                <div class="row text-center rounded py-1 bg-secondary bg-opacity-10">
                                    <div class="col-lg-3 mb-1">

                                        <input type="text" class="form-control" id="organization_name"
                                            name="organization[{{ $loop->iteration }}][name]"
                                            value="{{ $organisasi->nama }}">
                                    </div>
                                    <div class="col-lg-3 mb-1">

                                        <input type="text" class="form-control" id="experience_from"
                                            name="organization[{{ $loop->iteration }}][position]"
                                            value="{{ $organisasi->posisi }}">
                                    </div>
                                    <div class="col-lg-5 mb-1">

                                        <textarea name="organization[{{ $loop->iteration }}][remark]" class="form-control" style="height: 40px ;"
                                            id="oraganization_remark">{{ $organisasi->keterangan }}</textarea>
                                    </div>
                                    <div class="col-lg-1 mb-1">
                        ...
                        <div class="col-md-12">
                            ...
                            @forelse ($data->beasiswas as $beasiswa)
                                <input type="text" hidden name="scholarship[{{ $loop->iteration }}][id]"
                                    value="{{ $beasiswa->id }}">
                                <div class="row text-center rounded py-1 bg-secondary bg-opacity-10">
                                    <div class="col-lg-3 mb-1">

                                        <input type="text" class="form-control" id="institution_name"
                                            name="scholarship[{{ $loop->iteration }}][institution]"
                                            value="{{ $beasiswa->nama_institusi }}">
                                    </div>
                                    <div class="col-lg-3 mb-1">

                                        <input type="text" class="form-control" id="institution_place"
                                            name="scholarship[{{ $loop->iteration }}][place]"
                                            value="{{ $beasiswa->tempat }}">
                                    </div>
                                    <div class="col-lg-5 mb-1">

                                        <textarea name="scholarship[{{ $loop->iteration }}][remark]" class="form-control" style="height: 40px ;"
                                            id="institution_remark">{{ $beasiswa->keterangan }}</textarea>
                                    </div>
                                    <div class="col-lg-1 mb-1">
                        ...
                        <div class="col-md-12">
                            ...
                            @forelse ($data->rekrutment__lains as $rekrut)
                                <input type="text" hidden name="recruitment[{{ $loop->iteration }}][id]"
                                    value="{{ $rekrut->id }}">
                                <div class="row text-center rounded py-1 bg-secondary bg-opacity-10">
                                    <div class="col-lg-3 mb-1">

                                        <input type="text" class="form-control" id="recruitment_name"
                                            name="recruitment[{{ $loop->iteration }}][institution]"
                                            value="{{ $rekrut->perusahaan }}">
                                    </div>
                                    <div class="col-lg-3 mb-1">

                                        <input type="text" class="form-control" id="job_recruitment"
                                            name="recruitment[{{ $loop->iteration }}][job_position]"
                                            value="{{ $rekrut->posisi }}">
                                    </div>
                                    <div class="col-lg-5 mb-1">

                                        <textarea name="recruitment[{{ $loop->iteration }}][remark]" class="form-control" style="height: 40px ;"
                                            id="recruitment_remark">{{ $rekrut->keterangan }}</textarea>
                                    </div>
                                    <div class="col-lg-1 mb-1">
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-select" id="apply_via" name="apply_via"
                                ...
                                <option {{ $data->apply_via == 'Advertisement' ? 'selected' : '' }}
                                    value="Advertisement">Advertisement</option>
                                <option {{ $data->apply_via == 'Friend' ? 'selected' : '' }} value="Friend">Friend
                                </option>
                                <option {{ $data->apply_via == 'Family' ? 'selected' : '' }} value="Family">Family
                                </option>
                                <option {{ $data->apply_via == 'Other' ? 'selected' : '' }} value="Other">Other
                                </option>
                            </select>
                            <input type="text" id="apply_via_other" class="d-none form-control mt-2"
                                value="{{ old('apply_via', $data->apply_via) }}">
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            @forelse ($data->relatives as $relative)
                                <div class="row text-center rounded py-1 bg-secondary bg-opacity-10">
                                    <div class="col-lg-4 mb-1">
                                        <input type="text" hidden name="relatives[{{ $loop->iteration }}][id]"
                                            value="{{ $relative->id }}">
                                        <input type="text" class="form-control" id="relative_name"
                                            name="relatives[{{ $loop->iteration }}][name]"
                                            value="{{ $relative->nama }}">
                                    </div>
                                    <div class="col-lg-2 mb-1">

                                        <input type="text" class="form-control" id="relation_relatives"
                                            name="relatives[{{ $loop->iteration }}][relation]"
                                            value="{{ $relative->hubungan }}">
                                    </div>
                                    <div class="col-lg-2 mb-1">

                                        <input type="text" class="form-control" id="job_relatives"
                                            name="relatives[{{ $loop->iteration }}][department]"
                                            value="{{ $relative->departemen }}">
                                    </div>
                                    <div class="col-lg-3 mb-1">
                                        <textarea name="relatives[{{ $loop->iteration }}][remark]" id="remark_relatives" style="height: 40px ;"
                                            class="form-control">{{ $relative->keterangan }}</textarea>
