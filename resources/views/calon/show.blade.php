                        ...
                        <div class="card-header" id="heading{{ $formal->id }}formal">
                            <h2 class="mb-0">
                                <button class="btn btn-block text-left" type="button" data-toggle="collapse"
                                    data-target="#collapse{{ $formal->id }}formal" aria-expanded="true"
                                    aria-controls="collapse{{ $formal->id }}formal">
                                    {{ $formal->nama_instansi }}
                                </button>
                            </h2>
                        </div>

                        <div id="collapse{{ $formal->id }}formal" class="collapse"
                            aria-labelledby="heading{{ $formal->id }}formal" data-parent="#accordionExample">
                            <div class="card-body">
                ...
                @forelse($data->pendidikans->where('jenis_pendidikan','course') as $course)
                    <div class="card">
                        <div class="card-header" id="heading{{ $course->id }}course">
                            <h2 class="mb-0">
                                <button class="btn btn-block text-left" type="button" data-toggle="collapse"
                                    data-target="#collapse{{ $course->id }}course" aria-expanded="true"
                        ...
                        <div id="collapse{{ $course->id }}course" class="collapse"
                            aria-labelledby="heading{{ $course->id }}course" data-parent="#accordionExample">
                            <div class="card-body">
                ...
                @forelse($data->bahasas as $bahasa)
                    <div class="card">
                        <div class="card-header" id="heading{{ $bahasa->id }}bahasa">
                            <h2 class="mb-0">
                                <button class="btn btn-block text-left" type="button" data-toggle="collapse"
                                    data-target="#collapse{{ $bahasa->id }}bahasa" aria-expanded="true"
                                    aria-controls="collapse{{ $bahasa->id }}bahasa">
                                    {{ $bahasa->bahasa }}
                                </button>
                            </h2>
                        </div>

                        <div id="collapse{{ $bahasa->id }}bahasa" class="collapse"
                            aria-labelledby="heading{{ $bahasa->id }}bahasa" data-parent="#accordionExample">
                            <div class="card-body">
                ...
                @forelse($data->pengalaman__kerjas as $pengalaman)
                    <div class="card">
                        <div class="card-header" id="heading{{ $pengalaman->id }}pengalaman">
                            <h2 class="mb-0">
                                <button class="btn btn-block text-left" type="button" data-toggle="collapse"
                                    data-target="#collapse{{ $pengalaman->id }}pengalaman" aria-expanded="true"
                                    aria-controls="collapse{{ $pengalaman->id }}pengalaman">
                                    {{ $pengalaman->nama_perusahaan }}
                                </button>
                            </h2>
                        </div>

                        <div id="collapse{{ $pengalaman->id }}pengalaman" class="collapse"
                            aria-labelledby="heading{{ $pengalaman->id }}pengalaman" data-parent="#accordionExample">
                            <div class="card-body">
                ...
                @forelse($data->organisasis as $organisasi)
                    <div class="card">
                        <div class="card-header" id="heading{{ $organisasi->id }}organisasi">
                            <h2 class="mb-0">
                                <button class="btn btn-block text-left" type="button" data-toggle="collapse"
                                    data-target="#collapse{{ $organisasi->id }}organisasi" aria-expanded="true"
                                    aria-controls="collapse{{ $organisasi->id }}organisasi">
                                    {{ $organisasi->nama }}
                                </button>
                            </h2>
                        </div>

                        <div id="collapse{{ $organisasi->id }}organisasi" class="collapse"
                            aria-labelledby="heading{{ $organisasi->id }}organisasi" data-parent="#accordionExample">
                            <div class="card-body">
                                {{ $organisasi->posisi }}
                                <hr>
                ...
                @forelse($data->beasiswas as $scholar)
                    <div class="card">
                        <div class="card-header" id="heading{{ $scholar->id }}scholar">
                            <h2 class="mb-0">
                                <button class="btn btn-block text-left" type="button" data-toggle="collapse"
                                    data-target="#collapse{{ $scholar->id }}scholar" aria-expanded="true"
                                    aria-controls="collapse{{ $scholar->id }}scholar">
                                    {{ $scholar->nama_institusi }}
                                </button>
                            </h2>
                        </div>

                        <div id="collapse{{ $scholar->id }}scholar" class="collapse"
                            aria-labelledby="heading{{ $scholar->id }}scholar" data-parent="#accordionExample">
                            <div class="card-body">
                                {{ $scholar->tempat }}
                                <hr>
                                {{ $scholar->keterangan }}
                ...
                @forelse($data->rekrutment__lains as $recruitment)
                    <div class="card">
                        <div class="card-header" id="heading{{ $recruitment->id }}recruitment">
                            <h2 class="mb-0">
                                <button class="btn btn-block text-left" type="button" data-toggle="collapse"
                                    data-target="#collapse{{ $recruitment->id }}recruitment" aria-expanded="true"
                                    aria-controls="collapse{{ $recruitment->id }}recruitment">
                                    {{ $recruitment->perusahaan }}
                                </button>
                            </h2>
                        </div>

                        <div id="collapse{{ $recruitment->id }}recruitment" class="collapse"
                            aria-labelledby="heading{{ $recruitment->id }}recruitment"
                ...
                @forelse($data->relatives as $relative)
                    <div class="card">
                        <div class="card-header" id="heading{{ $relative->id }}relative">
                            <h2 class="mb-0">
                                <button class="btn btn-block text-left" type="button" data-toggle="collapse"
                                    data-target="#collapse{{ $relative->id }}relative" aria-expanded="true"
                                    aria-controls="collapse{{ $relative->id }}relative">
                                    {{ $relative->nama }}
                                </button>
                            </h2>
                        </div>

                        <div id="collapse{{ $relative->id }}relative" class="collapse"
                            aria-labelledby="heading{{ $relative->id }}relative" data-parent="#accordionExample">
                            <div class="card-body">
